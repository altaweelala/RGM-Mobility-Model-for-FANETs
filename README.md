...
These are the two files needed to run the Regulated Gauss-Markov mobility model published in **A New GPS Spoofing Attack and a Regulated Gauss-Markov Mobility Model for FANETs** in Ad Hoc Networks.
